...
ax.set_title("The influence to time about task out degree")
...
ax.set_title("The influence to memory about task out degree")
...
ax.set_ylabel('Time Decreased For Caching')  # Add a y-label to the axes.
ax.set_title("The influence to time about task\'s step")  # Add a title to the axes.
...
ax.set_title("The influence to memory about task\'s step")  # Add a title to the axes.
